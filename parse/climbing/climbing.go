// Package climbing implements precedence climbing algorithm for parsing mathematical expressions in infix notation.
package climbing
...
// New creates a new precedence climbing parser.
